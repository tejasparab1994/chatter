...
// Socket
var user = document.getElementById('User').innerText; //getting username
...
// Presence
var presences = {}; //handle presence to see users as they login
...
// Channels
var room = socket.channel('room:lobby', {}); //tell js about our channel
...
messageInput.addEventListener('keypress', function (e) {
  if (e.keyCode == 13 && messageInput.value != '') {
    //keypress enter and value not equal to empty
